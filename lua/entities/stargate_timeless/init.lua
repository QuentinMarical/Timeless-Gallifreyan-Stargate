...
ENT.Sounds = {
	Ring=Sound("stargate/gate_roll_timeless.mp3"), 
	Ring2=Sound("stargate/timeless/roll.wav"),
	Open=Sound("stargate/timeless/open.mp3"),
	Travel=Sound("stargate/timeless/gate_travel.mp3"),
	Close=Sound("stargate/timeless/gate_close.mp3"),
	Chevron=Sound("stargate/chevron_timeless.mp3"),
	Chevron2=Sound("stargate/timeless/chevron.mp3"),
	Inbound=Sound("stargate/chevron_timeless_incoming.mp3"),
	Lock=Sound("stargate/chevron_lock_timeless.mp3"),
	LockInbound=Sound("stargate/chevron_lock_timeless_incoming.mp3"),
	Fail=Sound("stargate/dial_fail_timeless.mp3"),
	OnButtonLock=Sound("stargate/chevron_lock_timeless_incoming.mp3"),
}
...
function ENT:Initialize()
    ...
    self.Entity:SetSubMaterial(0, "timeless/stargate/base_sg_gallifrey")
	self.Entity:SetSubMaterial(1, "timeless/stargate/glyphs_sg_gallifrey")
	self.Entity:SetSubMaterial(2, "timeless/stargate/chev_sg_gallifrey")
	self.Entity:SetSubMaterial(3, "timeless/stargate/glyphs_off_sg_gallifrey")
	self.Entity:SetSubMaterial(4, "timeless/stargate/side_sg_gallifrey")
	self.Entity:SetSubMaterial(5, "timeless/stargate/inner_sg_gallifrey")
	self.Entity:SetSubMaterial(6, "timeless/stargate/glyphs_on_sg_gallifrey")
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("stargate_timeless");
...
function ENT:AddRing()
	...
	for i=1,2 do
		...
		e:Spawn();
		e:Activate();
        e:SetMaterial("timeless/stargate/glyphs_on_sg_gallifrey")
...
function ENT:AddChevron()
	...
	for i=1,9 do
		...
		e:Fire("skin",2);
/*
1	=	madman07/stargate/light_back_sg1
2	=	madman07/stargate/light_off_sg1
3	=	madman07/stargate/chev_sg1
4	=	madman07/stargate/light_on_sg1
5	=	madman07/stargate/chev_sga
6	=	madman07/stargate/light_back_sga
7	=	madman07/stargate/light_off_sga
8	=	madman07/stargate/light_on_sga
9	=	madman07/stargate/chev_infinity
10	=	madman07/stargate/light_back_infinity
11	=	madman07/stargate/light_off_infinity
12	=	madman07/stargate/light_on_infinity
*/
		e:SetSubMaterial(4,"timeless/stargate/chev_sg_gallifrey")
		e:SetSubMaterial(5,"timeless/stargate/light_back_sg_gallifrey")
		e:SetSubMaterial(6,"timeless/stargate/light_off_sg_gallifrey")
		e:SetSubMaterial(7,"timeless/stargate/light_on_sg_gallifrey")
	end
end
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "stargate_timeless", StarGate.CAP_GmodDuplicator, "Data" )
end